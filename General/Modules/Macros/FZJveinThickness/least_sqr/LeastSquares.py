...
#
# Modification:
# extracted solely the least_squares function including its dependencies from the Scientific Python package
# 10.7.2014, D. Pflugfelder
# changed _chiSquare to call model in a vectorial fashion instead of a for loop. ~10% speed-up in my example
# 16.7.2014, D.Pflugfelder
...
import N, LA
import numpy as np
#from least_sqr.FirstDerivatives import DerivVar
